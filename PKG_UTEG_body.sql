...
to_char(skrattr_date, 'DAY', 'NLS_DATE_LANGUAGE=SPANISH') d�a, 
...
(SELECT to_char(to_date(SSRMEET_BEGIN_TIME, 'hh24mi'),'hh24:mi')||'-'||to_char(to_date(SSRMEET_END_TIME,'hh24mi'),'hh24:mi')||'-'||SLBRDEF_ROOM_NUMBER||'-'||STVBLDG_DESC||'-'||SLBRDEF_DESC
FROM SSRMEET,STVBLDG,SLBRDEF WHERE 1=1 AND SSRMEET_TERM_CODE = periodo and SSRMEET_CRN = crn and SSRMEET_WED_DAY is not null AND SSRMEET_ROOM_CODE = SLBRDEF_ROOM_NUMBER AND SSRMEET_BLDG_CODE = SLBRDEF_BLDG_CODE AND STVBLDG_CODE = SLBRDEF_BLDG_CODE)Mi�rcoles,
(SELECT to_char(to_date(SSRMEET_BEGIN_TIME, 'hh24mi'),'hh24:mi')||'-'||to_char(to_date(SSRMEET_END_TIME,'hh24mi'),'hh24:mi')||'-'||SLBRDEF_ROOM_NUMBER||'-'||STVBLDG_DESC||'-'||SLBRDEF_DESC 
...
(SELECT to_char(to_date(SSRMEET_BEGIN_TIME, 'hh24mi'),'hh24:mi')||'-'||to_char(to_date(SSRMEET_END_TIME,'hh24mi'),'hh24:mi')||'-'||SLBRDEF_ROOM_NUMBER||'-'||STVBLDG_DESC||'-'||SLBRDEF_DESC
FROM SSRMEET,STVBLDG,SLBRDEF WHERE 1=1 AND SSRMEET_TERM_CODE = periodo and SSRMEET_CRN = crn and SSRMEET_SAT_DAY is not null AND SSRMEET_ROOM_CODE = SLBRDEF_ROOM_NUMBER AND SSRMEET_BLDG_CODE = SLBRDEF_BLDG_CODE AND STVBLDG_CODE = SLBRDEF_BLDG_CODE)S�bado
