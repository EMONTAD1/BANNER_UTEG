...
select spriden_id Matricula, spriden_first_name||' '||spriden_last_name Nombre, decode(SZTFECH_DIA,1, 'Lunes',2, 'Martes',3,'Mi�rcoles',4,'Jueves',5,'Viernes',6,'S�bado',7,'Domingo') dia
