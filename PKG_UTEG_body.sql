...
(SELECT SSRMEET_WED_DAY FROM SSRMEET WHERE 1=1 AND SSRMEET_TERM_CODE = periodo and SSRMEET_CRN = crn)Mi�rcoles,
...
(SELECT SSRMEET_SAT_DAY FROM SSRMEET WHERE 1=1 AND SSRMEET_TERM_CODE = periodo and SSRMEET_CRN = crn)S�bado,
SSRMEET_ROOM_CODE salon,
STVBLDG_DESC edificio , 
SLBRDEF_DESC ubicaci�n,
